...
/**
 * Function that visually removes the grid
**/
...
/**
 *  Function that visually removes the tabs.
**/
Tabs.prototype.clearTabs = function() {

    this.tabPaper.remove();
}
...
FootMenu.prototype.initFooter = function() {
                ...
                **/
                postExport = function(callback) {
                    $.post(
                        ...
                        {'data': drawId}, 
                        function (data) {
                            // The data can be console.logged for the purpose of catching errors from the PHP-script.
                            //console.log(data);
                            callback(data, true);
                        });
                },
    ...
    sv.mouseup( function() {
        ...
        // Do not allow saving before there is a result in.
        if (TFplanner.resultGrid == null) {
            return;
        }
