...
/**
 * Sets up the 'Head-menu' with two buttons and some text
**/
HeadMenu.prototype.initMenu = function () {
    ...
    this.createHandlers(coll1.push(button1, text1), 1);
    this.createHandlers(coll2.push(button2, text2), 4);

}

/**
 * Adds mousehandlers to the buttons in the header.
 * @param coll - collection that includes a rectangle and a text-element.
 * @param val - A value used for showing the correct paper when button is pushed.
**/
HeadMenu.prototype.createHandlers = function (coll, val) {
